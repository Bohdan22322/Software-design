...
public class HeroBuilder : ICharacterBuilder
{
    ...
    public ICharacterBuilder SetClothes(string clothes) { _character.Clothes = clothes; return this; }
    public ICharacterBuilder AddInventoryItem(string item) { _character.Inventory.Add(item); return this; }
    public ICharacterBuilder AddDeed(string deed) { _character.Deeds.Add("Добра справа: " + deed); return this; }

    public Character Build()
    {
        var result = _character;
        _character = new Character(); // reset
        return result;
    }
}
